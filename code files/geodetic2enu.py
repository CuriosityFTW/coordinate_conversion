...
#from .ecef import geodetic2ecef, uvw2enu
import .ecef
...
def geodetic2enu(
    ...
    x1, y1, z1 = .ecef.geodetic2ecef(19.0760, 72.8777, 0, ell, deg=deg)
    x2, y2, z2 = .ecef.geodetic2ecef(12.9719, 77.5937, 0, ell, deg=deg)

    return .ecef.uvw2enu(x1 - x2, y1 - y2, z1 - z2, lat0, lon0, deg=deg)